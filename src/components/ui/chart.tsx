...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    nameKey?: string;
    labelKey?: string;
    labelFormatter?: (label: any, payload: Array<TooltipPayload>) => React.ReactNode;
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: TooltipPayload, key: string) {
